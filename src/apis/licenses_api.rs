...
pub enum UpdateLicenseError {
    ...
    pub async fn delete_license(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<DeleteLicenseError>> {
        ...
        let uri_str = format!("{}/licenses/{id}", configuration.base_path, id=id);
        ...
        if status.is_success() {
            ...
            let entity: Option<DeleteLicenseError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
    ...
    pub async fn find_license_by_id(configuration: &configuration::Configuration, id: &str, include: Option<&str>) -> Result<crate::models::License, Error<FindLicenseByIdError>> {
        ...
        if status.is_success() {
            ...
            let entity: Option<FindLicenseByIdError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
    ...
    pub async fn update_license(configuration: &configuration::Configuration, id: &str, license: crate::models::LicenseUpdateInput) -> Result<crate::models::License, Error<UpdateLicenseError>> {
        ...
        if status.is_success() {
            ...
            let entity: Option<UpdateLicenseError> = serde_json::from_str(&content).ok();
            let error = ResponseContent { status, content, entity };
            Err(Error::ResponseError(error))
        }
    }
